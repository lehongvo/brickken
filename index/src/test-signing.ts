...
async function testSigningClient() {
  try {
    ...
    try {
      ...
      console.log(`   ❌ Band Protocol query failed: ${(error as Error).message}`);
    }
    console.log("");
    ...
    try {
      ...
      console.log(`   ❌ Pyth Network query failed: ${(error as Error).message}`);
    }
    console.log("");
    ...
    try {
      ...
      console.log(`   ❌ Increment failed: ${(error as Error).message}`);
    }
    console.log("");
    ...
    if (walletAddress === owner) {
      ...
      try {
        ...
        console.log(`   ❌ Update description failed: ${(error as Error).message}`);
      }
    } else {
    ...
    if (walletAddress === owner) {
      ...
      try {
        ...
        console.log(`   ❌ Set Band Oracle address failed: ${(error as Error).message}`);
      }
      console.log("");
      ...
      try {
        ...
        console.log(`   ❌ Set Pyth Oracle address failed: ${(error as Error).message}`);
      }
    } else {
